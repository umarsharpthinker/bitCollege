            ...
            <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                <li>
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" class="admin-pic img-circle" src="http://api.randomuser.me/portraits/thumb/men/10.jpg">Hi,@if(\Illuminate\Support\Facades\Auth::Check()) {{\Illuminate\Support\Facades\Auth::user()->full_name}}  @endif <b class="caret"></b>
                    </a>
                ...
                {{--<li class="hidden-xs">--}}
                    ...
                    {{--</a>--}}
                {{--</li>--}}
                <li class=" page-topbar hidden-xs">
