            ...
            <div class="side-bar">
                <ul class="topnav menu-left-nest">
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a class="tooltip-tip2 ajax-load" href="{{route('blog-list')}}" title="Blog List"><i class="entypo-doc-text"></i><span>General Group</span></a>
                            </li>
                            <li>
                                <a class="tooltip-tip2 ajax-load" href="{{route('blog-detail')}}" title="Blog Detail"><i class="entypo-newspaper"></i><span>ICO Group</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="tooltip-tip ajax-load" href="{{route('videoChat')}}" title="Media">
                ...
                <ul id="menu-showhide" class="topnav menu-left-nest">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="tooltip-tip2 ajax-load" href="{{route('advance-form')}}" title="Andvance Form"><i class="icon-map"></i><span>Andvance Form</span></a>
                            </li>
                            <li>
