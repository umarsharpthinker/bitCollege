                                ...
                                <div class="panel-body">
                                    <form method="get" class="form-horizontal bucket-form">
                                        ...
                                        <div class="form-group has-success">
                                            <label for="inputSuccess" class="col-sm-3 control-label col-lg-3">Input with success</label>
                                            <div class="col-lg-6">
                                                <input type="text" id="inputSuccess" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group has-warning">
                                            <label for="inputWarning" class="col-sm-3 control-label col-lg-3">Input with warning</label>
                                            <div class="col-lg-6">
                                                <input type="text" id="inputWarning" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group has-error">
                                            <label for="inputError" class="col-sm-3 control-label col-lg-3">Input with error</label>
                                            <div class="col-lg-6">
