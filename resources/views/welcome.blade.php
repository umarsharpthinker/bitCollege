            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <div id="logo-mobile" class="visible-xs">
                        <h1>Downloaded From <a href="http://ow.ly/Tn1im"> N i t r o G F X . C O M</a>
                            <span>v1.2</span>
                        </h1>
                    </div>
                    ...
                    <div class="side-bar">
                        <ul class="topnav menu-left-nest">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a class="tooltip-tip2 ajax-load" href="{{route('blog-list')}}" title="Blog List"><i class="entypo-doc-text"></i><span>Blog List</span></a>
                                    </li>
                                    <li>
                                        <a class="tooltip-tip2 ajax-load" href="{{route('blog-detail')}}" title="Blog Detail"><i class="entypo-newspaper"></i><span>Blog Details</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                        ...
                        <ul id="menu-showhide" class="topnav menu-left-nest">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="tooltip-tip2 ajax-load" href="{{asset('table-dynamic')}}" title="Table Dynamic"><i class="entypo-menu"></i><span>Table Dynamic</span></a>
                                    </li>
                                </ul>
                            </li>
        ...
        <!--  PAPER WRAP -->
            <div class="wrap-fluid" >
                ...
                <div class="container-fluid paper-wrap bevel tlbr">
                    <div class="col-md-offset-10"><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#pfaModal">Open Modal</button><br><br>
                    </div>
                                        <div id="placeholder" style="width:100%;height:200px;"></div>

                    <h1 style="text-align: center"> Hello From Me</h1>
